...
export default function LandingPage() {
  ...
  useEffect(() => {
    async function checkStatus() {
      ...
      // If there's no session in cookies, they are definitely not logged in
      if (!session) return;
              ...
              <PricingCard 
                ...
                cta={
                  isAlreadyPro ? (
                    <Link
                      href="/billing"
                      className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#00c97a]/40 bg-transparent px-6 py-3 text-sm font-semibold text-[#00c97a] transition-colors hover:bg-[#00c97a]/10"
                    >
                      Manage subscription
                    </Link>
                  ) : (
                ...
                ctaHref={!isAlreadyPro ? "/pricing" : undefined}
                featured={true}
              />
            </div>
        ...
        <div className="max-w-7xl w-full px-6 flex flex-col">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-24">
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-2">
                <a href="https://github.com/0xJoy07/VibeForge" target="_blank" rel="noreferrer" className="text-zinc-400 hover:text-white transition-colors">
